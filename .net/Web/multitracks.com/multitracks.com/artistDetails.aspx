									...
									<ul id="playlist" class="song-list mod-new mod-menu">
										...
										<li class="song-list--item media-player--row">
											...
											<div class="song-list--item--right">
												<a class="song-list--item--primary"style="margin-left:2vw">Song Title</a>
												<a class="song-list--item--primary">Album name</a>
												<a class="song-list--item--primary" style="margin-left:-8vw"> BPM</a>
												<a class="song-list--item--primary" style="margin-left:-12vw">Rating</a>
											</div>
